...
void shift_left(int spec, std::string name_sp[], int status_sp[])
{
...
// Help adding patient
void shift_right(int spec, std::string name_sp[], int status_sp[])
{
	int len = queue_length[spec];
...
void get_next_patient()
{
	...
	std::cout << names[spec][0] << " please go with Dr\n";
